...
public class PBLogInTest extends Base_CLass
{
	...
	public void openBrowser() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		@BeforeMethod
		public void LoginToAppln() throws EncryptedDocumentException, IOException, InterruptedException
		{
			
		  login.ClickOnSignIN();
		  MobNum.EnterMobNum(UtilityClass.ReadPRopFdata("MobNum"));
		  MobNum.ClickOnSignInWithPwd();
		  pwd.EnterPwd(UtilityClass.ReadPRopFdata("Pwd"));
		  pwd.ClickOnSignIn(); 
		...
		@AfterMethod
		public void LogOutApplin(ITestResult s1) throws IOException, InterruptedException
		{
